<template>
    <section class="bg-gray-50 min-h-screen flex items-center justify-center">
        <div
            class="flex flex-col items-center justify-center w-full max-w-7xl px-6 py-8 mx-auto md:h-screen lg:py-0 md:flex-row gap-8"
        >
            <div
                    ...
                    <form class="space-y-4 md:space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="password"
                                placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 "
                                required
                            />
                        </div>
            ...
            <div class="hidden md:block w-full md:w-1/2">
                <img
                    class="w-[%95] h-[80vh] rounded-lg object-cover"
